...
public class FizzBuzzTest {
    ...
    // Test that we added it's not worth to add more test
    // because the code is not failed because we refactor the code
    @Test
    ...
    @Test
    @DisplayName("input 10 should return Buzz")
    void input10ShouldReturnBuzz() {
        FizzBuzz fizzBuzz = new FizzBuzz();
